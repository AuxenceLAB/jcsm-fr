...
if ! node --test scripts/security-images.test.cjs; then fail=1; fi
if ! node --test scripts/public-images.test.cjs; then fail=1; fi
if ! node --test scripts/proof-claims.test.cjs; then fail=1; fi
if ! node --test scripts/diacritics.test.cjs; then fail=1; fi
